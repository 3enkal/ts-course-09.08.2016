...
export class FlikrAppAsModuleHomework {
    ...
    constructor({elem, uri, queryMethod, apiKey}:opt) {
        this.elem = elem;
        this.uri = uri;
    ...
    public set setSearchHandler(handler:(input:string | Request) => PromiseLike<any>) {
